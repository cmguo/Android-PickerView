package com.bigkoo.pickerview.lunar;
...
public class LunarCalendar extends GregorianCalendar {
    ...
    public int getActualMaximum(int field) {
        ...
        if (field == Calendar.DAY_OF_MONTH) {
            return (int) LunarUtils.lengthOfMonth(lunarYear, lunarMonth, isLeapMonth);
        }
    ...
    public int get(int field) {
        ...
        if (field == Calendar.MONTH) {
            return (leapMonth == 0 || lunarMonth <= leapMonth) ? lunarMonth : lunarMonth + 1;
        }
        if (field == Calendar.DAY_OF_MONTH) {
    ...
    public String getDayName() {
        return LunarData.getDayName(this.dayOfLunarMonth);
    }

    public String getMonthName() {
        return this.isLeapMonth() ? "闰" : "" + LunarData.getMonthName(this.lunarMonth) + "月";
    }

    public String getYearName() {
        return LunarData.getYearName(this.lunarYear) + "年";
    }
    ...
    private void computeBySolarDate() {
        computeBySolarDate(super.get(Calendar.YEAR), super.get(Calendar.MONTH), super.get(Calendar.DATE));
    }
